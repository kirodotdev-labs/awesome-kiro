...
> **Disclaimer:** This list is maintained by kiro-labs and sponsored by Amazon. The projects listed here are **not all built, owned, endorsed, or maintained by Amazon or AWS** unless explicitly noted as such. Inclusion does not constitute an endorsement. Each project is governed by its own license and maintainers — review them before use. Use at your own risk. See [DISCLAIMER.md](DISCLAIMER.md) for full details.
